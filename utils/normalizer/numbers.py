...
def _percentage(match) -> str:
    ...
    percent: str = _inflect.number_to_words(int(percent), andword='')
    result = f"{sign} {percent} percent"
    return result
...
def normalize_numbers(text):
    ...
    text=re.sub(_percentage_re,_percentage,text)
