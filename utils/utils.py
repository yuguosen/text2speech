...
if __name__ == '__main__':
    ...
    print(normalize_en("Post like top YouTubers and accelerate your growth with top-quality hooks. Don't let CapCut hold you back, a great hook is 99% of what makes your video go viral."))